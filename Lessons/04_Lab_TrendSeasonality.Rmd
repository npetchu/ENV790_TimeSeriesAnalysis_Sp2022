...
raw_inflow_data <- read.table(file=paste(getwd(),"/Data/inflowtimeseries.txt", sep=''),header=FALSE,skip=0)
...
test<-energy_data2 %>% as.data.frame()

ggplot(test, aes(x=Month, y=test[,2])) +
            geom_line(color="blue") +
